...
freeze(adftable_dif_log_gdp_pc_s_c) log_gdp_pc_sa.uroot(dif=1)
freeze(adftable_dif_log_gdp_pc_s_ct) log_gdp_pc_sa.uroot(exog=trend, dif=1)
freeze(adftable_dif_log_gdp_pc_s_nc) log_gdp_pc_sa.uroot(exog=none, dif=1)

freeze(adftable_dif_pub_inv_gdp_s_c) x1_sa.uroot(dif=1)
freeze(adftable_dif_pub_inv_gdp_s_ct) x1_sa.uroot(exog=trend, dif=1)
freeze(adftable_dif_lpub_inv_gdp_s_nc) x1_sa.uroot(exog=none, dif=1)
